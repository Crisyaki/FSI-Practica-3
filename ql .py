...
# TAREA1: numero promedio de acciones que el agente tarda de partir de un sitio aleatorio hasta que sale
# es decir: num++ en bucle while state e imprimir /100
# TAREA2: implementar metodo greedy: linea clave "action = getRndAction(state)" -> q de state tiene algun valor?
# si hay algo distinto de 0, cogemos la accion maxima; else al azar.
# TAREA3: E-greedy: lanzamos dado de 10 caras: si sale de 1 a 9, cogemos la info; si no, al azar

# PRESENTAR: tabla con metodo aleatorio, greedy y E-greedy para ver la diferencia entre ellas -> 7 veces; e-greedy 0.9, 0.8 y 0,5

#sugerencias profe:
# PARA USAR LAS LISTAS:
# l = [5,3,7,8,2]
# max(l) da 8
# np.argmax(l) da 3 (indice del maximo)
